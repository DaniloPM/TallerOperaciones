...
public class Cilindro extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		txtradio = (EditText) findViewById(R.id.txtRadioCilindro);
		txtaltura = (EditText) findViewById(R.id.txtAlturaCilindro);
		
	}
	 public void calcularCilindro(View view) {
		 String operacion="Volumen del cilindro";
		...
		if (validar()) {
			...
			resultado=((pi)*(Math.pow(dato,2))*(altura));
			...
			Intent intent = new Intent(Cilindro.this, ResultadoCilindro.class);
			Bundle b = new Bundle();
